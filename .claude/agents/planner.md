---
name: planner
description: Use this agent when there is no active OpenSpec change, you need to pick the next work item, or you want to decide what to do next from unfinished feedback and current project context.
...
- Decide whether a change is in progress.
