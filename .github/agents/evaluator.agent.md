---
description: "Use when: you need to evaluate a plan, assess the current OpenSpec change, generate tests from a proposal, validate readiness before implementation, or check whether the project aligns with active work"
name: "evaluator"
